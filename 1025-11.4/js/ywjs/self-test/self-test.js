...
/**
     ...
     * 函数说明：隐藏家庭保障测试问题界面
     * @param  #fiQuestionContent 家庭保障测试问题界面的id
 */
function fiTestQuestionNone(){
  $("#fiQuestionPart").fadeOut(10);
  //RobotSDK.clearUserKeyWords();
}
...
/**
     ...
     * @param  #fiQuestionContent 家庭保障测试问题界面的id
 */
function fiTestQuestionDisplay(){
  $("#fiQuestionPart").fadeIn(1000);
}

/**

     * 函数说明：隐藏家庭保障测试推荐跳转界面
     * @param  #productProPage 家庭保障测试问题界面的id
 */
function fiTestProNone(){
  $("#productProPage").fadeOut(10);
  RobotSDK.clearUserKeyWords();
}
...
/**
     ...
     * @param  #productProPage 家庭保障测试问题界面的id
 */
function fiTestProDisplay(){
  $("#productProPage").fadeIn(1000);
}

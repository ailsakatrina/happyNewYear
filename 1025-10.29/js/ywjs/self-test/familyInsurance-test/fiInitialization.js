...
//0为单选，1为多选
FI_TEXT[0] = ["享受日常健康运动，你遇到过哪些小麻烦？（多选）",1];
FI_TEXT[1] = ["人生的每个阶段都充满着不同快乐，您现在是？（单选）",0];
FI_TEXT[2] = ["陪伴孩子的成长，让你最操心的是...（单选）",0];
FI_TEXT[3] = ["生活好习惯你能HOLD住哪些？（多选）",1];
FI_TEXT[4] = ["假期太短，你的时间主要都去哪儿了？（单选）",0];
FI_TEXT[5] = ["土豪的生活，你做到了哪些？（多选）",1];
FI_TEXT[6] = ["孩子大了我们就老了，你有为那个时候做了哪些准备？（多选）",1];
FI_TEXT[7] = ["辛苦干了一年，钱最主要花哪去了？（单选）",0];
